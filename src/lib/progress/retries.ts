...
import { RECENT_PROGRESS_WINDOW_DAYS } from '@/lib/progress/v3-aggregation'
import {
...
/**
 * Keeps recent retries with exact current score/rubric/mode compatibility.
 * A parent can predate the window, but the retry itself must be recent.
 */
