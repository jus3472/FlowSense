...
export function selectCategory(series: Readonly<Record<SkillCategory, ProgressSeries>>, descending: boolean): SkillCategory | null {
  return (Object.keys(series) as SkillCategory[]).filter((key) => series[key].state === 'ready').sort((a, b) => {
