...
- conciseness: only semantic repeated ideas, redundant sentences, irrelevant content, unnecessary tangents, and unnecessary qualifiers. Do not report fillers, false starts, abandoned phrases, or closers listed as mechanically_owned; code assigns those only to Conciseness.
